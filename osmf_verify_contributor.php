 ...
 */
function osmf_verify_contributor_civicrm_caseTypes(&$caseTypes) {
  _osmf_verify_contributor_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function osmf_verify_contributor_civicrm_themes(&$themes) {
  _osmf_verify_contributor_civix_civicrm_themes($themes);
}
 ...
 */
//function osmf_verify_contributor_civicrm_preProcess($formName, &$form) {
//
//}
 ...
 */
//function osmf_verify_contributor_civicrm_navigationMenu(&$menu) {
//  _osmf_verify_contributor_civix_insert_navigation_menu($menu, 'Mailings', array(
...
//    'separator' => 0,
//  ));
//  _osmf_verify_contributor_civix_navigationMenu($menu);
//}
